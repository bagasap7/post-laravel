    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            ...
            <form action="/register" method="post">
                ...
                <div class="form-floating">
                    <input type="email" class="form-control rounded-bottom @error('email') is-invalid @enderror" name="email" id="email" placeholder="example@mail" required value="{{ old('email') }}">
